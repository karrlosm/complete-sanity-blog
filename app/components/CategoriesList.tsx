...
export default function CategoriesList({ categories }:{
    ...
    return (!isMobile ?
        <div className="w-full pl-3 max-lg:pl-0">
            <div className="bg-gray-200 dark:bg-gray-800 w-full h-full rounded-sm p-4">
                ...
                <div className="flex flex-col">
                    {categories.map((category, index) => (
                        ...
                        >
                            <Link
                                className=" border-b-[1px] border-gray-300 dark:border-gray-700 group py-4 flex items-center justify-between"
